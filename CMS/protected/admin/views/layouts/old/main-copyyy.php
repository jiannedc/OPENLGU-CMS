	...
	<div id="main" class="row">
		<div class="small-4 medium-3 large-2 columns">
			...
			<nav class="sidebar light">
				<ul>
					<li class="stick bg-cyan"><?php echo CHtml::link('<i class="icon-home"></i>Home',array('admin/index')); ?></li>
					...
					<li class="stick bg-green"><?php echo CHtml::link('<i class="icon-user"></i>Users',array('user/admin')); ?>
