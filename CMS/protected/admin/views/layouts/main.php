...
<head>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/foundation/stylesheets/general_foundicons.css">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/foundation/stylesheets/general_foundicons_ie7.css">
		...
		<div class="small-4 medium-3 large-2 columns">
			...
			<nav class="sidebar light">
				<ul>
					...
					<li class="stick bg-teal"><?php echo CHtml::link('<i class="icon-newspaper"></i>Articles',array('article/create')); ?></li>
					<li class="stick bg-green"><?php echo CHtml::link('<i class="icon-user"></i>Users',array('user/index')); ?>	</li>
					<li class="stick bg-lime"><?php echo CHtml::link('<i class="icon-file"></i>Files',array('file/create')); ?>	</li>
					<li class="stick bg-magenta"><?php echo CHtml::link('<i class="icon-pictures"></i>Photos',array('photo/index')); ?></li>
					<li class="stick bg-yellow"><?php echo CHtml::link('<i class="icon-cog"></i>Services',array('services/index')); ?></li>
					<li class="stick bg-orange"><?php echo CHtml::link('<i class="icon-calendar"></i>Sliders',array('slider/index')); ?></li>
					<li class="stick bg-red"><?php echo CHtml::link('<i class="icon-window"></i>Homepage',array('lgudata/index')); ?></li>
					<li class="stick bg-darkViolet"><?php echo CHtml::link('<i class="icon-file"></i>Static Pages',array('spage/index')); ?></li>					
					<li class="stick bg-darkIndigo"><?php echo CHtml::link('<i class="icon-mail"></i>Messages',array('messages/index')); ?></li>
				</ul>
			</nav>
			</div>
		</div>
