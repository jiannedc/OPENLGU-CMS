...
<body>
	...
	if(!Yii::app()->user->isGuest){
		...
		?>
			...
			<ul class="right button-group even-2 admin-button" >
				<li><a class="button tiny" href="<?php echo Yii::app()->request->baseUrl; ?>/admin.php">Go to Admin</a></li>
				<li><a class="button tiny">Edit Homepage</a></li>
			</ul>
			</div>
			</div>
	<?php	
	...
	<?php $this->renderPartial('//layouts/_banner', array('isHome'=>false))?>
	<nav class="container-topbar">
	<div class="row">
		<div class="small-12 large-12 columns">
		<nav class="top-bar nomargin" data-topbar>
    ...
    <div class="large-3 columns widget-area">
		<div class="social-media section">
			...
			<a href="<?php echo $lgu_data['facebook_link']; ?>" target="_blank"> <span class="flaticon-facebook24 valign"></span>Like us on Facebook</a><br />
			<a href="<?php echo $lgu_data['facebook_link']; ?>" target="_blank"> <span class="flaticon-social19 valign"></span>Follow us on Twitter</a>
			</div>
		</div>
	...
	<div class="large-3 columns widget-area ">	
		<div class="contact-us section">
			...
			<div class="body small-icon">
			<span class="valign flaticon-phone25"></span>Contact No.: <?php echo $lgu_data['contact_no']; ?><br />
			<span class="valign flaticon-office"></span>Fax Number: <?php echo $lgu_data['fax_no']; ?><br />
			<span class="valign flaticon-email29"></span>Email: <?php echo $lgu_data['email_address']; ?>
			</div>
		</div>
		<div class="contact-us section">
