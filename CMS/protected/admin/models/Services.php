...
class Services extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('service_name, service_description, content, procedures, requirements', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('service_id, service_name, service_description, content, procedures, requirements, service_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('procedures',$this->procedures,true);
